...
class AuroToast extends r {
  ...
  static register(name = "auro-toast") {
    AuroLibraryRuntimeUtils$3.prototype.registerComponent(name, AuroToast);
  }
  ...
  render() {
    return this.visible ? u`
      <div aria-live="polite" class="toastContainer">
        ${this.noIcon ? undefined : u`
          <${this.iconTag} customColor customSvg class="typeIcon" part="type-icon">
            ${this.variant === 'custom' ? undefined : u`${this.getVariantIcon()}`}
          </${this.iconTag}>
        `}
