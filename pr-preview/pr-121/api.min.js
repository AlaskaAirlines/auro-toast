...
function createToast(toaster, { id, variant, message }) {
  ...
  console.log("toast created", toast); // eslint-disable-line no-console
}
...
function initDynamicToastsExample() {
  ...
  setTimeout(() => {
    toastDefs.forEach((def) => createToast(toaster, def));

    toastDefs.forEach(({ id, btnId }) => {
